...
| -------------------- | -------------- | ------------ | ------------------- |
| JobPosting API       | 10回/24時間/IP | メモリベース | userApiKey使用時    |
| ブログレビュアー API | 10回/24時間/IP | メモリベース | userApiKey使用時    |
| Webアドバイザー API  | 10回/24時間/IP | メモリベース | userApiKey使用時    |
...
- 複数ユーザーが同一IP（企業LANなど）からアクセスする場合、10回/24時間/IP の制限が全体に適用されます
