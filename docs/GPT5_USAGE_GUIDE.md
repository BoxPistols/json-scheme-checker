...
| ------------ | ---------- | ---------- | ----------- | ----------- |
| gpt-5-nano   | $0.0005    | $0.002     | $0.0025     | ¥0.375      |
| gpt-5-mini   | $0.003     | $0.0075    | $0.0105     | ¥1.575      |
...
- **gpt-5-nano**: 最もコスト効率が良い（10K入力 + 5K出力で $0.0025）
- **gpt-5-mini**: 追加コストで表現力と出力安定性を強化できる
- **gpt-4o**: 品質重視の場合に選択（コストは大幅に高い）
...
- リアルタイムチャット
- 対話型アプリケーション
- サーバーコストを抑えながら低レイテンシを求める場合

### gpt-5-miniを推奨

- 少し長めのテキスト生成が必要で、わずかなコスト増を許容できる場合
- マーケティング文章などで追加の表現力が欲しい場合

### gpt-4oを推奨

- 最高品質のアウトプットが必要な場合
- 生成内容の事後編集コストを最小限にしたい場合
