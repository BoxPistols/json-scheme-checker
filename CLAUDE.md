...
このプロジェクトでは、GitHub ActionsとClaude AIを使用した自動修正システムを導入しています。

### 概要

PRの作成・更新時に自動的に問題を検出し、可能な限り自動修正します。
...
- [AI自動修正システム セットアップガイド](./.ai-docs/shared/13_AI_AUTO_FIX_SETUP.md)
...
3. **不確実な修正（Issue作成）**
   - 判断が難しい修正は別Issueとして切り出し

### レポート

修正完了後、PRに以下の情報を含むレポートが自動投稿されます：
